      ...
      items: [
        {
          ...
          productId: 'p1',
          quantity: 3,
          product: { id: 'p1', name: 'A', price: '10', imageUrl: null, deliveryOption: null, vendor: null },
          lineTotal: '30.00',
        },
        {
          id: 'item-2',
          productId: 'p2',
          quantity: 2,
          product: { id: 'p2', name: 'B', price: '20', imageUrl: null, deliveryOption: null, vendor: null },
          lineTotal: '40.00',
        },
      ],
      subtotal: '70.00',
