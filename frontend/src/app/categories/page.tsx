            ...
            {categories.map((category) => {
              ...
              return (
                <Link
                  ...
                  className={`relative flex min-h-[160px] flex-col justify-end overflow-hidden rounded-md bg-gradient-to-br p-5 text-white ${theme.gradientFrom} ${theme.gradientTo}`}
                >
